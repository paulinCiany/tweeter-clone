        ...
        <section className="timeLine">
          ...
          <div className="twitContainer borderBotton">
            <div className="userPicInputComm">
              <img src="src/assets/react.svg" alt="user pic" />
              <textarea className='txtArea' type="text" placeholder="What's happening?" />
            </div>
            <div className="MetaAndBtnTweet">
              <div className="tweeter-editor-actions">
                <button><img src="src/assets/Icons/Media.svg" className='metaStle'  alt="" /></button>
                <img src="src/assets/Icons/Gif.svg" className='metaStle' alt="" />
                <img src="src/assets/Icons/Poll.svg" className='metaStle' alt="" />
                <img src="src/assets/Icons/Emoji.svg" className='metaStle' alt="" />
                <img src="src/assets/Icons/Schedule.svg" className='metaStle' alt="" />
              </div>
              <BtnTweet classTweet="btnTweet" />
            </div>
          </div>
