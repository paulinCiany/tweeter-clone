...
function TweetAction({ tab }) {
    const [like, setLike] = useState(tab.favorites);
    const [toggle, setToggle] = useState(true);

    function onlikeBtnOnclik() {
        setLike(parseInt(like) + (toggle ? 1 : -1));
        setToggle(!toggle)
    }
    ...
    return (
        <>
            <div className="tweet-action ">
                ...
                <button className="tweetActionSyle grayColor">
                    ...
                    <span className="colorWhite hoverBtnLike">{tab.replies}</span>
                </button>

                <button className="tweetActionSyle svgShareColor grayColor">
                    <svg className="svgShareColor" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="colorWhite svgShareColor">{tab.retweets}</span>
                </button>

                <button className="tweetActionSyle svgLikeColor grayColor" onClick={onlikeBtnOnclik}>
                    ...
                    <span className="colorWhite grayColor svgLikeColor">{like}</span>
                </button>

                <button className="tweetActionSyle">
